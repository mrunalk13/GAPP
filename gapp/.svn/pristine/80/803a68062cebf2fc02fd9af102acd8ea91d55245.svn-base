...
<body>
	...
	<div class="section">
		<div class="panel-group" id="accordion" style="width: 50%">
			...
			<form action="EditAddReq.html" method="POST" class="form-horizontal"
				enctype="multipart/form-data">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">Update Additional Requirement</h4>
					</div>
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="fvalue" required/>
							</div>
						</div>
